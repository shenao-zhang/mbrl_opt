...
class ModelTrainer:
    ...
    def train(
        ...
        Args:
            ...
            agent: for calculating the model value loss.

            env: for calculating the model value loss.
        ...
        for epoch in epoch_iter:
            ...
            for batch in tqdm.tqdm(dataset_train, disable=disable_tqdm):
                loss, meta = self.model.update(batch, self.optimizer, agent=agent, env=env, termination_fn=termination_fn)
